    ...
    <div class="form-container">
        ...
        <form action="/insertopt" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="url" name="map_link_1" class="form-control" value="{{ old('map_link_1') }}" required>
            </div>

            <div class="mb-4">
                <label for="map_link_2" class="form-label">Link Map 2</label>
                <input type="url" name="map_link_2" class="form-control" value="{{ old('map_link_2') }}" required>
            </div>
