...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card p-3">
                    <form method="post" action="{{ route('foto.update',$fotoTransportasi->id) }}" enctype="multipart/form-data">
                        @csrf 
                        ...
                        <div class="mb-3">
                            ...
                            <div class="image-preview" id="thumbnailInput">
                                ...
                                <img src="{{ asset('foto/' . $fotoTransportasi->foto) }}" alt="Old Image Preview" id="previewImage" style="display: block;">
                                @else
