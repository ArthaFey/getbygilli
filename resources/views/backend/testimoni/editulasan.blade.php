            ...
            <form action="/updateulasan/{{ $data->id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="image-preview" id="thumbnailInput">
                        <img src="{{ asset('fotoprofile/' . $data->foto) }}" alt="Old Image Preview" id="previewImage" style="display: block;">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" name="rate" id="rate">
                        <option selected>{{ old('rate', $data->rate) }}</option>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="ulasan" id="content">{{ old('ulasan', $data->ulasan) }}</textarea>
                </div>
